      ...
      <div className="container">
        <div className="flex flex-col items-center">
          <Image
            ...
            alt="Person peeping from behind laptop"
          ></Image>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <a
            href="#project"
            className="z-40 inline-flex items-center gap-2 border boder-white/15 px-6 h-12 rounded-xl"
          >
            <span className="font-semibold">Explore More Work</span>
